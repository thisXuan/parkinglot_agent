...
def workstation_ai(query: str, mcopilotContext=None) -> str:
    '''
...
@mcp.tool()
def search_cases(query: str, mis_id: str = None, mcopilotContext=None) -> str:
    '''
...
if __name__ == "__main__":
    mcp.run(port=3001, transport="sse")